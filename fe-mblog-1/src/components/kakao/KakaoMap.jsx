...
const KakaoMap = () => {
  ...
  useEffect(()=>{
    ...
    for(let i=0; i<positions.length; i++){
      ...
      //마커에 이벤트 등록하는 함수를 만들고 즉시 호출되도록 클로저 만듦
  ...
  return (
    <div style={{display:"flex", alignItems:"center", justifyContent:"space-around"}}>
        <div id="map" ref={kakaomap} style={{width: "700px", height: "500px", marginBottom:"20px", border:"2px solid lightgray", borderRadius:"20px"}}>
        </div>
